...
public class Customize extends Progress
{
    ...
    public Customize(TextView fadingYear, TextView pendingYear, ProgressBar progressBar, TextView progressText)
    {
        ...
        colors(progressText, progressFill);
    }
    ...
    public void colors(TextView progressText, Drawable progressFill)
    {
